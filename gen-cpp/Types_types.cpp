...
const std::map<int, const char*> _TStmtType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kTStmtTypeValues, _kTStmtTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
TUniqueId::TUniqueId(const TUniqueId& other24) {
  hi = other24.hi;
  lo = other24.lo;
}
TUniqueId& TUniqueId::operator=(const TUniqueId& other25) {
  hi = other25.hi;
  lo = other25.lo;
  return *this;
}
...
uint32_t TFunction::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  bool isset_is_persistent = false;
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->binary_type = (TFunctionBinaryType::type)ecast32;
...
void TFunction::printTo(std::ostream& out) const {
  ...
  out << ", " << "is_persistent=" << to_string(is_persistent);
  out << ")";
}
