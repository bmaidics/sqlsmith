...
class ImpalaService_Cancel_args {
 public:
  ...
  ImpalaService_Cancel_args(const ImpalaService_Cancel_args&);
  ImpalaService_Cancel_args& operator=(const ImpalaService_Cancel_args&);
...
class ImpalaService_Cancel_result {
 public:
  ...
  ImpalaService_Cancel_result(const ImpalaService_Cancel_result&);
  ImpalaService_Cancel_result& operator=(const ImpalaService_Cancel_result&);
...
class ImpalaService_ResetCatalog_args {
 public:
  ...
  ImpalaService_ResetCatalog_args(const ImpalaService_ResetCatalog_args&);
  ImpalaService_ResetCatalog_args& operator=(const ImpalaService_ResetCatalog_args&);
...
class ImpalaService_ResetCatalog_result {
 public:
  ...
  ImpalaService_ResetCatalog_result(const ImpalaService_ResetCatalog_result&);
  ImpalaService_ResetCatalog_result& operator=(const ImpalaService_ResetCatalog_result&);
...
class ImpalaService_ResetTable_args {
 public:
  ...
  ImpalaService_ResetTable_args(const ImpalaService_ResetTable_args&);
  ImpalaService_ResetTable_args& operator=(const ImpalaService_ResetTable_args&);
...
class ImpalaService_ResetTable_result {
 public:
  ...
  ImpalaService_ResetTable_result(const ImpalaService_ResetTable_result&);
  ImpalaService_ResetTable_result& operator=(const ImpalaService_ResetTable_result&);
...
class ImpalaService_GetRuntimeProfile_args {
 public:
  ...
  ImpalaService_GetRuntimeProfile_args(const ImpalaService_GetRuntimeProfile_args&);
  ImpalaService_GetRuntimeProfile_args& operator=(const ImpalaService_GetRuntimeProfile_args&);
...
class ImpalaService_GetRuntimeProfile_result {
 public:
  ...
  ImpalaService_GetRuntimeProfile_result(const ImpalaService_GetRuntimeProfile_result&);
  ImpalaService_GetRuntimeProfile_result& operator=(const ImpalaService_GetRuntimeProfile_result&);
...
class ImpalaService_CloseInsert_args {
 public:
  ...
  ImpalaService_CloseInsert_args(const ImpalaService_CloseInsert_args&);
  ImpalaService_CloseInsert_args& operator=(const ImpalaService_CloseInsert_args&);
...
class ImpalaService_CloseInsert_result {
 public:
  ...
  ImpalaService_CloseInsert_result(const ImpalaService_CloseInsert_result&);
  ImpalaService_CloseInsert_result& operator=(const ImpalaService_CloseInsert_result&);
...
class ImpalaService_PingImpalaService_args {
 public:
  ...
  ImpalaService_PingImpalaService_args(const ImpalaService_PingImpalaService_args&);
  ImpalaService_PingImpalaService_args& operator=(const ImpalaService_PingImpalaService_args&);
...
class ImpalaService_PingImpalaService_result {
 public:
  ...
  ImpalaService_PingImpalaService_result(const ImpalaService_PingImpalaService_result&);
  ImpalaService_PingImpalaService_result& operator=(const ImpalaService_PingImpalaService_result&);
...
class ImpalaService_GetExecSummary_args {
 public:
  ...
  ImpalaService_GetExecSummary_args(const ImpalaService_GetExecSummary_args&);
  ImpalaService_GetExecSummary_args& operator=(const ImpalaService_GetExecSummary_args&);
...
class ImpalaService_GetExecSummary_result {
 public:
  ...
  ImpalaService_GetExecSummary_result(const ImpalaService_GetExecSummary_result&);
  ImpalaService_GetExecSummary_result& operator=(const ImpalaService_GetExecSummary_result&);
...
class ImpalaServiceClient : virtual public ImpalaServiceIf, public  ::beeswax::BeeswaxServiceClient {
 public:
  ...
  ImpalaServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::beeswax::BeeswaxServiceClient(iprot, oprot) {}
...
class ImpalaServiceConcurrentClient : virtual public ImpalaServiceIf, public  ::beeswax::BeeswaxServiceConcurrentClient {
 public:
  ImpalaServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::beeswax::BeeswaxServiceConcurrentClient(prot, prot) {}
  ImpalaServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::beeswax::BeeswaxServiceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
  ...
  void Cancel( ::impala::TStatus& _return, const  ::beeswax::QueryHandle& query_id);
  int32_t send_Cancel(const  ::beeswax::QueryHandle& query_id);
  void recv_Cancel( ::impala::TStatus& _return, const int32_t seqid);
  void ResetCatalog( ::impala::TStatus& _return);
  int32_t send_ResetCatalog();
  void recv_ResetCatalog( ::impala::TStatus& _return, const int32_t seqid);
  void ResetTable( ::impala::TStatus& _return, const TResetTableReq& request);
  int32_t send_ResetTable(const TResetTableReq& request);
  void recv_ResetTable( ::impala::TStatus& _return, const int32_t seqid);
  void GetRuntimeProfile(std::string& _return, const  ::beeswax::QueryHandle& query_id);
  int32_t send_GetRuntimeProfile(const  ::beeswax::QueryHandle& query_id);
  void recv_GetRuntimeProfile(std::string& _return, const int32_t seqid);
  void CloseInsert(TInsertResult& _return, const  ::beeswax::QueryHandle& handle);
  int32_t send_CloseInsert(const  ::beeswax::QueryHandle& handle);
  void recv_CloseInsert(TInsertResult& _return, const int32_t seqid);
  void PingImpalaService(TPingImpalaServiceResp& _return);
  int32_t send_PingImpalaService();
  void recv_PingImpalaService(TPingImpalaServiceResp& _return, const int32_t seqid);
  void GetExecSummary( ::impala::TExecSummary& _return, const  ::beeswax::QueryHandle& handle);
  int32_t send_GetExecSummary(const  ::beeswax::QueryHandle& handle);
  void recv_GetExecSummary( ::impala::TExecSummary& _return, const int32_t seqid);
};
