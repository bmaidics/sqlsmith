...
TGetLogReq::TGetLogReq(const TGetLogReq& other294) {
  operationHandle = other294.operationHandle;
}
TGetLogReq& TGetLogReq::operator=(const TGetLogReq& other295) {
...
TGetLogResp::TGetLogResp(const TGetLogResp& other296) {
  status = other296.status;
  log = other296.log;
}
TGetLogResp& TGetLogResp::operator=(const TGetLogResp& other297) {
